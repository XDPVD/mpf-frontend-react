...
export function useUser(){
    ...
    if(!context) {
        throw new Error('DEV Error: The component must be a child of a context ' +
            'provider in order to use its useContext');
    }

    // use useCookies useState
    const [cookies ,setCookie, removeCookie] = useCookies([cookieNames.USER, cookieNames.TOKEN]);
